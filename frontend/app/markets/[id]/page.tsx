...
import { ArrowLeft, TrendingUp, TrendingDown, Clock, Users, DollarSign, Activity, ExternalLink } from 'lucide-react';
...
export default function MarketDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950">
      <div className="container mx-auto px-4 py-8">
        {/* Back link */}
        <Link href="/markets" className="inline-flex items-center text-neutral-400 hover:text-white mb-6">
        ...
        <div className="flex items-start gap-4 mb-2">
          <h1 className="text-2xl font-bold text-white">{marketData.question}</h1>
          <Badge
            className={
              marketData.resolved
              ...
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between mb-3">
                    <div className="flex items-center gap-2">
                      <span className="text-green-400 font-medium text-lg">YES</span>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-red-400 font-medium text-lg">NO</span>
                    </div>
                  </div>
                  <PriceBar
                    yesPrice={yesPrice}
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-neutral-800">
                  <div className="text-center p-4 bg-green-500/10 rounded-lg border border-green-500/20">
                    <p className="text-sm text-neutral-400 mb-1">YES Price</p>
                  ...
                  <div className="text-center p-4 bg-red-500/10 rounded-lg border border-red-500/20">
                    <p className="text-sm text-neutral-400 mb-1">NO Price</p>
